...
public class _14211529_Ô¬ÕñÓî_4_MainWindow extends JFrame implements ActionListener{

	private static _14211529_Ô¬ÕñÓî_4_EmployeeList empList;
	...
	public static void main(String[] args) {
		new _14211529_Ô¬ÕñÓî_4_MainWindow();
	}

	public _14211529_Ô¬ÕñÓî_4_MainWindow() {
		...
		empList = new _14211529_Ô¬ÕñÓî_4_EmployeeList();
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==ComEmpItem){
			_14211529_Ô¬ÕñÓî_4_InputComInfoWin comwin = new _14211529_Ô¬ÕñÓî_4_InputComInfoWin();
			comwin.setVisible(true);
			_14211529_Ô¬ÕñÓî_4_CommissionEmployee ComEmp;
			...
			_14211529_Ô¬ÕñÓî_4_InputBaseComInfoWin bpcomwin = new _14211529_Ô¬ÕñÓî_4_InputBaseComInfoWin();
			bpcomwin.setVisible(true);
			_14211529_Ô¬ÕñÓî_4_BasePlusCommissionEmployee BasePlusComEmp;
			...
			_14211529_Ô¬ÕñÓî_4_AverageEarningWin averagewin = new _14211529_Ô¬ÕñÓî_4_AverageEarningWin(empList.getTotal(), averageEarning);
			averagewin.setVisible(true);;
		}
	}

	public static _14211529_Ô¬ÕñÓî_4_EmployeeList getEmpList() {
		return empList;
	}

	public void setEmpList(_14211529_Ô¬ÕñÓî_4_EmployeeList empList) {
		_14211529_Ô¬ÕñÓî_4_MainWindow.empList = empList;
	}
}
