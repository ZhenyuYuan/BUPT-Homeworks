...
public class _14211529_袁振宇_3_EmployeeTest {
	private static Scanner sc;
	public static void main(String[] args){
		String FirstName;
		String LastName;
		String SocialSecurityNumber;
		_14211529_袁振宇_3_EmployeeList empList;
		empList = new _14211529_袁振宇_3_EmployeeList();
		for(int i = 1; i <= 10; i++){
			...
			case 1:
				...
				_14211529_袁振宇_3_SalaridEmployee semp;
				semp = new _14211529_袁振宇_3_SalaridEmployee(FirstName, LastName, SocialSecurityNumber, WeeklySalary);
				empList.Add(semp);
				break;
			case 2:
				...
				_14211529_袁振宇_3_CommissionEmployee cemp;
				cemp = new _14211529_袁振宇_3_CommissionEmployee(FirstName, LastName, SocialSecurityNumber, GrossSales, CommissionRate);
				empList.Add(cemp);
				break;
			case 3:
				...
				_14211529_袁振宇_3_BasePlusCommissionEmployee bcemp;
				bcemp = new _14211529_袁振宇_3_BasePlusCommissionEmployee(FirstName, LastName, SocialSecurityNumber, GrossSales1, CommissionRate1, BaseSalary);
				empList.Add(bcemp);
				break;
			case 4:
				...
				Wage = sc.nextDouble(); 	
				Hours = sc.nextDouble();
				_14211529_袁振宇_3_HourlyEmployee hemp;
				hemp = new _14211529_袁振宇_3_HourlyEmployee(FirstName, LastName, SocialSecurityNumber, Wage, Hours);
				empList.Add(hemp);
				break;
			}
		}
